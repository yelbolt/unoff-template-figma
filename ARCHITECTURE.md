...
|-------|--------|-------------|
| **Canvas** | Figma API operations | `canvas/figma/canvas-api.md`, `canvas/figma/data-storage.md` |
| **Bridge** | UI ↔ Canvas communication | `bridge/figma/communication-pattern.md`, `bridge/figma/bridge-functions.md` |
